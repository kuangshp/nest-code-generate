...
var findPath = function (dirName) {
    ...
    if (resultPath) {
        return dirNames.length > 1 ? path_1.join.apply(void 0, __spreadArray([resultPath], dirNames.slice(1))) : resultPath;
    }
    else {
...
var baseEntity = function () {
    ...
    */
    ...
    if (collect !== '' && collect != null) {
        collect = collect.split(',').map(function (field) { return field.trim(); }).filter(function (field) { return field !== ''; });
    }
