...
var outpuRoot = (0, path_1.join)(cwd, 'demo');
...
function genFiles(type, options) {
    ...
    var table = options.table;
    if (table) {
        table.table_uppercase_name = (0, _1.underlineToHump)(table.table_name);
...
function genFile(type, options) {
    ...
    var modulePath = (0, path_1.join)(outpuRoot, type + "/" + module_name);
