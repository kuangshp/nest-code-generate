                        ...
                        return [4 /*yield*/, utils_1.hasTableName(tableNames, function () { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            structure = _a.sent();
                                            columnStructure = parser_1.transformStructure(structure);
                                            // 生成实体类
                                            parser_1.generateEntity(columnStructure, this.targetPath);
                                            return [2 /*return*/];
                                    }
                                });
                            }); })];
                                    ...
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, Promise.all(tableNames.map(function (name) { return __awaiter(_this, void 0, void 0, function () {
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0:
                                                            controllerPath = path_1.join(this.targetPath, 'controllers');
                                                            servicesPath = path_1.join(this.targetPath, 'services');
                                                            utils_1.emptyTheMkdir(controllerPath);
                                                            utils_1.emptyTheMkdir(servicesPath);
                                                            return [4 /*yield*/, this.generateEntity()];
                                                        case 1:
                                                            _a.sent();
                                                            options = { module_name: this.moduleName, table: { table_name: name } };
                                                            genFiles_1.genFiles(types_1.GENFILE_TYPES.CONTROLLER, options, controllerPath);
                                                            genFiles_1.genFiles(types_1.GENFILE_TYPES.SERVICE, options, servicesPath);
                                                            return [2 /*return*/];
                                                    }
                                                });
                                            }); }))];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        genFiles_1.genFiles(types_1.GENFILE_TYPES.FULL, options, controllerPath);
                        return [2 /*return*/];
                }
            });
        });
