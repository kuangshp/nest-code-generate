...
var Parse = /** @class */ (function () {
    ...
    Parse.prototype.prompt = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, type, moduleName, targetPath;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), type = _a.type, moduleName = _a.moduleName;
                        this.type = type;
    ...
    Parse.prototype.generateEntity = function () {
        return __awaiter(this, void 0, void 0, function () {
            var tableNames, structure, columnStructure;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        tableNames = this.tableName.split(',');
                        if (!(tableNames.length > 0)) return [3 /*break*/, 2];
                        return [4 /*yield*/, (0, parser_1.getTableStructure)(tableNames)];
                    case 1:
                        structure = _a.sent();
                        columnStructure = (0, parser_1.transformStructure)(structure);
                        // 生成实体类
                        (0, parser_1.generateEntity)(columnStructure, this.targetPath);
                        return [3 /*break*/, 3];
                    case 2: throw new TypeError('Please enter the <table_name> field: nest-code-generate <table_name> <module_name> [options]');
    ...
    Parse.prototype.generateTier = function () {
        return __awaiter(this, void 0, void 0, function () {
            var controllPath, servicesPath, options;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        controllPath = (0, path_1.join)(this.targetPath, 'controllers');
                        servicesPath = (0, path_1.join)(this.targetPath, 'services');
                        (0, utils_1.emptyTheMkdir)(controllPath);
                        (0, utils_1.emptyTheMkdir)(servicesPath);
                        return [4 /*yield*/, this.generateEntity()];
                    case 1:
                        _a.sent();
                        options = { is_full: false, module_name: this.moduleName, table: { table_name: this.tableName } };
                        (0, genFiles_1.genFiles)(types_1.GENFILE_TYPES.CONTROLLER, options, controllPath);
                        (0, genFiles_1.genFiles)(types_1.GENFILE_TYPES.SERVICE, options, servicesPath);
                        return [2 /*return*/];
                }
            });
        });
