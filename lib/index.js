                                        ...
                                        case 0: return [4 /*yield*/, Promise.all(tableNames.map(function (name) { return __awaiter(_this, void 0, void 0, function () {
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0:
                                                            collectPath = {
                                                                controllers: path_1.join(this.targetPath, 'controllers'),
                                                                services: path_1.join(this.targetPath, 'services')
                                                            };
                                                            utils_1.emptyTheMkdir(collectPath.controllers);
                                                            utils_1.emptyTheMkdir(collectPath.services);
                                                            return [4 /*yield*/, this.generateEntity()];
                                                        case 1:
                                                            _a.sent();
                                                            options = { module_name: this.moduleName, table: { table_name: name } };
                                                            genFiles_1.genFiles(types_1.GENFILE_TYPES.CONTROLLER, options, collectPath);
                                                            genFiles_1.genFiles(types_1.GENFILE_TYPES.SERVICE, options, collectPath);
                                                            return [2 /*return*/];
                                                    }
                                                });
                                            }); }))];
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            genFiles_1.genFiles(types_1.GENFILE_TYPES.FULL, options, collectPath);
                                            return [2 /*return*/];
                                    }
                                });
                            }); })];
