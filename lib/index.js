                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, Promise.all(tableNames.map(function (name) { return __awaiter(_this, void 0, void 0, function () {
                                                var controllerPath, servicesPath, options;
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0:
                                                            controllerPath = (0, path_1.join)(this.targetPath, 'controllers');
                                                            servicesPath = (0, path_1.join)(this.targetPath, 'services');
                                                            (0, utils_1.emptyTheMkdir)(controllerPath);
                                                            (0, utils_1.emptyTheMkdir)(servicesPath);
                                                            return [4 /*yield*/, this.generateEntity()];
                                                        case 1:
                                                            _a.sent();
                                                            options = { module_name: this.moduleName, table: { table_name: name } };
                                                            (0, genFiles_1.genFiles)(types_1.GENFILE_TYPES.CONTROLLER, options, controllerPath);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        options = { module_name: this.moduleName, table: { table_name: this.tableName } };
                        (0, genFiles_1.genFiles)(types_1.GENFILE_TYPES.FULL, options, controllerPath);
                        return [2 /*return*/];
                }
            });
        });
